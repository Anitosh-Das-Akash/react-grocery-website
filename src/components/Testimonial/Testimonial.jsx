...
const Testimonial = () => {
  return (
    <section>
      <div className="max-w-[1400px] mx-auto px- py-20 ">
        <Heading highlight="Customers" heading="Saying" />

        <div className="py-5 gap-x-3 flex justify-end">
          <button className="custom-prev text-2xl text-zinc-800 rounded-lg w-11 h-11 bg-zinc-100 flex justify-center items-center hover:bg-gradient-to-b hover:from-orange-400 hover:to-orange-500 hover:text-white">
            <IoIosArrowBack />
          </button>

          <button className="custom-next text-2xl text-zinc-800 rounded-lg w-11 h-11 bg-zinc-100 flex justify-center items-center hover:bg-gradient-to-b hover:from-orange-400 hover:to-orange-500 hover:text-white">
            <IoIosArrowForward />
          </button>
        </div>
              ...
              <SwiperSlide className="bg-zinc-100 rounded-xl p-8">
                <div className="flex gap-5 items-center">
                  ...
                  <div>
                    ...
                    <span className="flex flex-row text-amber-500 mt-3 text-xl gap-1">
                      {
